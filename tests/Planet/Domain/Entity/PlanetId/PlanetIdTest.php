...
class PlanetIdTest extends TestCase
{
    /** @test */
    public function should_create_planet_id_when_receive_a_valid_uuid_v4(): void
    {
        $id = PlanetId::fromString('de305d54-75b4-431b-adb2-eb6b9e546014');
    ...
    {
        $this->expectException(PlanetIdInvalidArgumentException::class);

        PlanetId::fromString($uuid);
    }
